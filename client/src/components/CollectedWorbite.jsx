...
const CollectedWorbite = ({worbiteObject}) => {
  ...
  return (
    <button className={`${backgroundColor} w-full p-3 [grid-row-start:1] [grid-column-start:1] flex flex-col justify-center rounded-[14px] mb-2 text-left `}>
      <div className='mb-2'>
